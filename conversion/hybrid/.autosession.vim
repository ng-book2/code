...
vmap ]% ]%m'gv``
vmap a% [%v]%
noremap autocmd Filetype html,xhtml map \p :call PreviewCurrentPage()
...
nmap <SNR>27_WS <Plug>AlignMapsWrapperStart
snoremap <S-Tab> i<Right>=TriggerSnippet()
...
set formatprg=tidy\ -quiet\ -i\ -xml\ -wrap\ 0
set grepprg=ack
set helplang=en
set history=1000
set hlsearch
...
silent only
cd ~/projects/fs/ng/books/ng2-book/manuscript/code/conversion/hybrid
